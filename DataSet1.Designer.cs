...
namespace Customers_db {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomersRow AddCustomersRow(string Surname, string Name, string Middlename, string Passport) {
        ...
        public partial class CustomersRow : global::System.Data.DataRow {
            ...
            public string Passport {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Passport\' в таблице \'Customers\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsPassportNull() {
                return this.IsNull(this.tableCustomers.PassportColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetPassportNull() {
                this[this.tableCustomers.PassportColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Customers_db.DataSet1TableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customers] WHERE (([Id] = @Original_Id) AND ((@IsNull_Surname = 1 AND [Surname] IS NULL) OR ([Surname] = @Original_Surname)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Middlename = 1 AND [Middlename] IS NULL) OR ([Middlename] = @Original_Middlename)) AND ((@IsNull_Passport = 1 AND [Passport] IS NULL) OR ([Passport] = @Original_Passport)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([Surname], [Name], [Middlename], [Passport]) VALUE" +
                "S (@Surname, @Name, @Middlename, @Passport);\r\nSELECT Id, Surname, Name, Middlena" +
                "me, Passport FROM Customers WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [Surname] = @Surname, [Name] = @Name, [Middlename] = @Middlename, [Passport] = @Passport WHERE (([Id] = @Original_Id) AND ((@IsNull_Surname = 1 AND [Surname] IS NULL) OR ([Surname] = @Original_Surname)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Middlename = 1 AND [Middlename] IS NULL) OR ([Middlename] = @Original_Middlename)) AND ((@IsNull_Passport = 1 AND [Passport] IS NULL) OR ([Passport] = @Original_Passport)));
SELECT Id, Surname, Name, Middlename, Passport FROM Customers WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Customers_db.Properties.Settings.Default.CustomersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Surname, Name, Middlename, Passport FROM dbo.Customers";
        ...
        public virtual int Delete(int Original_Id, string Original_Surname, string Original_Name, string Original_Middlename, string Original_Passport) {
        ...
        public virtual int Insert(string Surname, string Name, string Middlename, string Passport) {
            if ((Surname == null)) {
        ...
        public virtual int Update(string Surname, string Name, string Middlename, string Passport, int Original_Id, string Original_Surname, string Original_Name, string Original_Middlename, string Original_Passport, int Id) {
            if ((Surname == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Surname, string Name, string Middlename, string Passport, int Original_Id, string Original_Surname, string Original_Name, string Original_Middlename, string Original_Passport) {
            return this.Update(Surname, Name, Middlename, Passport, Original_Id, Original_Surname, Original_Name, Original_Middlename, Original_Passport, Original_Id);
        }
    }
